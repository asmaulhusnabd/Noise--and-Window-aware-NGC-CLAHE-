...
# To make synthetic degraded low contrast image
- python -m src.run_make_synth --src data/real --dst data/synth --mode soft
# To run the methods (CLAHE, NGC-CLAHE, Our method) on the synthetic low contrast image
- python -m src.run_methods   --src data/synth --out data/outputs --mode soft
# To get the output on three different metrices
